...
const unsigned int gfMult3[256]{
...
const unsigned int gfMult9[256]{
...
const unsigned int gfMult11[256]{
...
const unsigned int gfMult13[256]{
...
const unsigned int gfMult14[256]{
...
//Lookup Tables for substitution in subBytes and invSubBytes
...
int main(int argc, char* argv[]) {
	...
	if (getKeyType(keyStr) == 2) {
		newKey.key[0][0] = (unsigned int)keyStr[0];
		newKey.key[1][0] = (unsigned int)keyStr[1];
		newKey.key[2][0] = (unsigned int)keyStr[2];
		newKey.key[3][0] = (unsigned int)keyStr[3];
		newKey.key[0][1] = (unsigned int)keyStr[4];
		newKey.key[1][1] = (unsigned int)keyStr[5];
		newKey.key[2][1] = (unsigned int)keyStr[6];
		newKey.key[3][1] = (unsigned int)keyStr[7];
		newKey.key[0][2] = (unsigned int)keyStr[8];
		newKey.key[1][2] = (unsigned int)keyStr[9];
		newKey.key[2][2] = (unsigned int)keyStr[10];
		newKey.key[3][2] = (unsigned int)keyStr[11];
		newKey.key[0][3] = (unsigned int)keyStr[12];
		newKey.key[1][3] = (unsigned int)keyStr[13];
		newKey.key[2][3] = (unsigned int)keyStr[14];
		newKey.key[3][3] = (unsigned int)keyStr[15];
	}
	else {
		newKey.key[0][0] = (((unsigned int)keyStr[0] << 4) | (unsigned int)keyStr[1]);
		newKey.key[1][0] = (((unsigned int)keyStr[2] << 4) | (unsigned int)keyStr[3]);
		newKey.key[2][0] = (((unsigned int)keyStr[4] << 4) | (unsigned int)keyStr[5]);
		newKey.key[3][0] = (((unsigned int)keyStr[6] << 4) | (unsigned int)keyStr[7]);
		newKey.key[0][1] = (((unsigned int)keyStr[8] << 4) | (unsigned int)keyStr[9]);
		newKey.key[1][1] = (((unsigned int)keyStr[10] << 4) | (unsigned int)keyStr[11]);
		newKey.key[2][1] = (((unsigned int)keyStr[12] << 4) | (unsigned int)keyStr[13]);
		newKey.key[3][1] = (((unsigned int)keyStr[14] << 4) | (unsigned int)keyStr[15]);
		newKey.key[0][2] = (((unsigned int)keyStr[16] << 4) | (unsigned int)keyStr[17]);
		newKey.key[1][2] = (((unsigned int)keyStr[18] << 4) | (unsigned int)keyStr[19]);
		newKey.key[2][2] = (((unsigned int)keyStr[20] << 4) | (unsigned int)keyStr[21]);
		newKey.key[3][2] = (((unsigned int)keyStr[22] << 4) | (unsigned int)keyStr[23]);
		newKey.key[0][3] = (((unsigned int)keyStr[24] << 4) | (unsigned int)keyStr[25]);
		newKey.key[1][3] = (((unsigned int)keyStr[26] << 4) | (unsigned int)keyStr[27]);
		newKey.key[2][3] = (((unsigned int)keyStr[28] << 4) | (unsigned int)keyStr[29]);
		newKey.key[3][3] = (((unsigned int)keyStr[30] << 4) | (unsigned int)keyStr[31]);
	}
